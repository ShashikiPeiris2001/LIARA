  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-12 pb-6 px-4 md:px-8">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300">(011) 286 7511</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <FaPhone className="mt-1 text-gray-400" />
              <div>
                ...
                <p className="text-gray-300">077 3446447</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300">info@liara.lk</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <FaEnvelope className="mt-1 text-gray-400" />
              <div>
                ...
                <p className="text-gray-300">online@liara.lk</p>
              </div>
            </li>
          </ul>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              <span className="w-20 text-gray-300">Mon-Fri</span>
              <span>9:00AM - 6:00PM</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="w-20 text-gray-300">Saturday</span>
              <span>9:00AM - 2:00PM</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="w-20 text-gray-300">Sunday</span>
        ...
        <motion.div variants={itemVariants} className="space-y-4">
          ...
          <form className="flex">
            <input
              ...
              className="px-4 py-3 rounded-l-lg focus:outline-none text-gray-800 w-full"
            />
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="bg-primary text-white px-4 rounded-r-lg flex items-center"
            >
              <FiSend size={20} />
            </motion.button>
          </form>
      ...
      <motion.div 
        ...
        className="max-w-7xl mx-auto mt-12 pt-6 border-t border-gray-700 text-center text-gray-400"
      >
